  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-400 to-blue-500 relative">
        <div className="absolute top-0 left-0 w-full h-16 bg-gradient-to-r from-purple-400 to-blue-500 flex justify-center items-center">
          <p
            style={{
        ...
        <div className="row-span-3 row-start-2 row-end-4 w-screen flex justify-center items-center z-0">
          <Background activeTab={activeTab} setActiveTab={setActiveTab}>
            {activeTab === "tab3" ? <PasswordGenerator /> : <FetchForm />}
          </Background>
        </div>
      </div>
    </>
